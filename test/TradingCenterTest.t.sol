...
contract TradingCenterTest is Test {
    ...
    function setUp() public {
        ...
        upgradeableProxy = new UpgradeableProxy(address(tradingCenter));
        // 3. Assigns proxy address to have interface of TradingCenter
        proxyTradingCenter = TradingCenter(address(upgradeableProxy));
    ...
    function testUpgrade() public {
        ...
        upgradeableProxy.upgradeTo(address(new TradingCenterV2()));
    ...
    function testRugPull() public {
        // TODO:
        TradingCenterV2 proxyTradingCenterV2 = TradingCenterV2(
        ...
        // Try to upgrade the proxy to TradingCenterV2
        upgradeableProxy.upgradeTo(address(new TradingCenterV2()));
        // And withdraw the users' usdc and usdt
        proxyTradingCenterV2.withdraw(user1);
        proxyTradingCenterV2.withdraw(user2);
